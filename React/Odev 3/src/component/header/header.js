...
function Header() {
  ...
  const findCoordinates = (e) => {
    e.preventDefault()
    fetch(`https://api.openweathermap.org/geo/1.0/direct?q=${location}&limit=5&appid=d79827f43d2526cbfe5d088133e97994`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const findLocation = () => {
    ...
    fetch(`https://api.openweathermap.org/data/2.5/forecast?lat=${coordinates.lat}&lon=${coordinates.lon}&appid=d79827f43d2526cbfe5d088133e97994`)
      .then((res) => res.json())
      .then((data) => {
