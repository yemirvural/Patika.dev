...
const yoga = createYoga({
  ...
  resolvers: {
    ...
    Event: {
      ...
      participants: (parent) => {
        const founder = participants.find(participant => participant.user_id === parent.user_id)
        return [founder, ...participants.filter(participant => participant.event_id === parent.id)]
      }
